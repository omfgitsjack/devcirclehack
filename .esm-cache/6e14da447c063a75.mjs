let request;_7c0‍.w("request",[["default",function(v){request=v}]]);let config;_7c0‍.w("config",[["default",function(v){config=v}]]);let Welcome;_7c0‍.w("../actions/Welcome",[["default",function(v){Welcome=v}]]);
