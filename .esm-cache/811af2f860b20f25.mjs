let request;_60b‍.w("request",[["default",function(v){request=v}]]);let config;_60b‍.w("config",[["default",function(v){config=v}]]);let Welcome;_60b‍.w("../actions/Welcome",[["default",function(v){Welcome=v}]]);
